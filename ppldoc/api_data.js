define({ "api": [
  ...
  {
    "type": "get",
    "url": "/posts/bycategory?cat=category&page=page_no",
  ...
  {
    "type": "get",
    "url": "/posts/:postId/comments?page=page_no",
  ...
  {
    "type": "get",
    "url": "/posts/filtered?category=cat&flaged=true&sortBy=field&page=page_no",
  ...
  {
    "type": "put",
    "url": "/users/verifyUser?email=email&verificationCode=code",
    "title": "Verify user",
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "status",
            "description": "<p>updated password status.</p>"
          }
        ]
      },
      "examples": [
